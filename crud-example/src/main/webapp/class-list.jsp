		...
		<c:forEach var="cList" items="${listClass}">
			<tr>
				...
				<td><a href="editClass?id=<c:out value='${cList.id}' />">Edit</a>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="newTeacherSubject?id=<c:out value='${cList.className}' />">Assign Subjects and Teachers</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="classReport?id=<c:out value='${cList.className}' />">Class Report</a>
				</td>
			</tr>
		</c:forEach>
	</table>
