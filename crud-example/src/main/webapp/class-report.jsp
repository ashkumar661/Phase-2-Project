...
<body>
	<center>
		...
		<sql:setDataSource var="db" driver="com.mysql.cj.jdbc.Driver"
			url="jdbc:mysql://localhost:3306/LearnersAcademy" user="root" password="123456" />
	...
	select * from student where stuClass='<%=request.getParameter("id")%>';
	</sql:query>
		...
		<table border="1" cellpadding="5">
			...
			<c:forEach var="studentList" items="${studentRecord.rows}">
				<tr>
					...
					<td>${studentList.stuGender}</td>
					<td>${studentList.stuDOB}</td>
